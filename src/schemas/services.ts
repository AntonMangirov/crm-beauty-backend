...
export const CreateServiceSchema = z.object({
  name: z
    ...
    .max(60, 'Название услуги не должно превышать 60 символов'),
  price: z
    .number()
  ...
  durationMin: z
    .number()
    .int()
    .min(15, 'Длительность должна быть не менее 15 минут')
    .max(300, 'Длительность не должна превышать 300 минут (5 часов)'),
